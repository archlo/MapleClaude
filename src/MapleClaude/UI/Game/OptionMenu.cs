...
public sealed class OptionMenu : GamePanel
{
    ...
    public OptionMenu(WzTextureLoader loader, WzPackage? ui, BuiltInFont? font)
    {
        ...
        _btClose = MakeButton(loader, opt, "BtClose", () => IsVisible = false);
        _btOk = MakeButton(loader, opt, "BtOK", () => IsVisible = false);
        _btCancel = MakeButton(loader, opt, "BtCancel", () => IsVisible = false);
    ...
    private void ApplyLayout()
    {
        ...
        if (_btOk != null) _btOk.Position = Position + new Vector2(280, 370);
        if (_btCancel != null) _btCancel.Position = Position + new Vector2(340, 370);
    }
    ...
    public override void Draw(SpriteBatch sb, Texture2D white)
    {
        ...
        {
            var rect = new Rectangle((int)Position.X, (int)Position.Y, 398, 388);
            sb.Draw(white, rect, new Color(15, 15, 25, 230));
            DrawBorder(sb, white, rect);
            _font?.Draw(sb, "Options", Position + new Vector2(170, 5), new Color(220, 200, 150));
        }
    ...
    public override bool HandleMouseButton(int x, int y, bool down)
    {
        ...
        return new Rectangle((int)Position.X, (int)Position.Y, 398, 388).Contains(x, y);
    }
